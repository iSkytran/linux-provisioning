...
yay -S zsh keepassxc visual-studio-code-bin google-chrome dropbox

# Install i3 and related software
yay -S xorg-server xorg-xinit i3-wm dmenu i3lock i3status picom hsetroot rxvt-unicode rofi vlc
